...
describe('GET /discovery - a simple api endpoint', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sections = response.body;
                    sections.forEach(function (section) {
                        section.restaurants.forEach(function (resturant) {
                            var distanceBetweenUserLocationAndResturant = helperFunctions_1.getDistanceBetweenTwoCoordinates([24.941, 60.1709], resturant.location);
    ...
    test('Open restaurants (online=true) should have precedence over closed(online=false) even if the popularity of the closed resturant is greater than opened one ', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    newRestaurants.forEach(function (resturant) {
                        expect(date_fns_1.differenceInCalendarMonths(new Date(resturant.launch_date), date_fns_1.startOfToday())).toBeLessThanOrEqual(4);
                    });
                    return [2 /*return*/];
            }
        });
    }); });
    test('should not show any resturants if the user distance is more than 1.5km from resturant', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, sections;
        return __generator(this, function (_a) {
            switch (_a.label) {
